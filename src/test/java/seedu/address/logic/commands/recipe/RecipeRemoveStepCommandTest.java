...
public class RecipeRemoveStepCommandTest {
    ...
    public void constructor_validInput() {
        ...
        assertEquals(c, new RecipeRemoveStepCommand(VALID_RECIPE_INDEX, VALID_STEP_INDEX));
    }
    ...
    public void execute_invalidInput() {
        ...
        RecipeRemoveStepCommand d = new RecipeRemoveStepCommand(OUT_OF_BOUNDS_RECIPE_INDEX, VALID_STEP_INDEX);
