...
public class CookbookListCommandParserTest {
    private static final String VALID_INDEX_STRING = "";
    private static final String INVALID_INDEX_STRING = "invalid xyz";

    @Test
    public void parse_validInput() throws ParseException {
        CookbookListCommandParser c = new CookbookListCommandParser();
        assertEquals(c.parse(VALID_INDEX_STRING), new CookbookListCommand());
    }
