...
- Format: `cookbook add n/NAME`
- Example:
* `cookbook add n/Bacon Carbonara` +
    Adds a new recipe with the name 'Bacon Carbonara'.

==== Delete a recipe from the cookbook
This command allows you to delete a recipe of the specified index from the cookbook.

- Format: `cookbook delete INDEX`
- Example:
* `cookbook delete 1` +
    Deletes recipe 1 from the cookbook.
