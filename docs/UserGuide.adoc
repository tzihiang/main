...
==== Tag a recipe
This command allows you to tag a recipe with short one-word descriptions.
...
==== Untag a recipe
This command allows you to remove a previously added tag from a recipe. If no tags are specified, all the tags for the recipe will be removed.
...
This command allows you to view a recipe (and its ingredients and steps) from the cookbook according to a serving size, and then cook it.  Once this command is executed, the ingredients used for the recipe will be deducted from the ingredients inventory. If no serving size is provided, the default serving size in the recipe will be used.
...
This command allows you to create a shopping list with in seconds with this command by adding the missing ingredients in a recipe to a shopping list, according to a serving size. If no serving size is provided, the default serving size in the recipe will be used.
