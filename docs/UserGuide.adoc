...
Cook and view a recipe from the cookbook according to a serving size.  Once this command is executed, the ingredients used for the recipe will be deducted from the ingredients inventory.
