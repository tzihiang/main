...
Add a preparation step 2 (Bring water to boil) to recipe 1.
* `recipe 2 insert x/next s/Add a teaspoon of salt in the soup` +
Add the next preparation step (Add a teaspoon of salt in the soup) to recipe 2.
...
- Example:
* `recipe 1 remove x/2` +
Remove preparation step 2 from the recipe 1.
...
Add a tag (Pasta) to the recipe 1.
...
Remove a tag (Beef) from the recipe 1.
