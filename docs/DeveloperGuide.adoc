...
==== Sequence diagram
The following sequence diagram shows how the recipe adding function works:

image::CookbookAddRecipeSequenceDiagram.png[]

==== How the feature works
Step 1: Input the command in the command box and hit kbd:[Enter] on the keyboard
