...
* **Alternative 1 (Current choice)**: Move all ingredients
...
** Cons: Lesser functionality to users that really want to only move certain ingredients

* **Alternative 2:** Allow users to move individually or exclude some ingredients when moving
...
** Pros: Lesser implementations, more time to focus on other parts of the project
** Cons: Poorer user experience for users that do not want to move all ingredients from the cart to inventory on a regular basis,
