...
* *Minor enhancement*:
** Contributed to basic structure of `Step` and `Tag` classes in recipes.
...
*** Reported bugs and suggestions for other teams in the class (example: https://github.com/hans555/ped/issues[1])
